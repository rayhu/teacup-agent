...
built for the job. Every fix is a merged, independently-reviewed pull request, linked from
that file. It's a living log, not a highlight reel — updated the moment the next attempt
finds something new.
