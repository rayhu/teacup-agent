...
`docs/threat-model.md` (what is trusted, what is not, and what is not defended
against), `docs/integration.md` (the `--json` contract an external caller relies
on), `NOTES.md` (the original study notes this grew from).
